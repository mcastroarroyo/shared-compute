...
| M3 | Model registry (Cloudflare R2) + macOS/Linux provider packaging | **code done** — signed manifest, verified download, launchd/systemd installers, release CI. Pending: R2 bucket to host `models.ayni-ai.com` |
