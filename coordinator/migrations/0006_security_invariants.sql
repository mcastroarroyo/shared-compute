-- Security invariants: one job/device settlement and one consumer debit per job.
-- Empty job_id values are legacy rows and intentionally excluded from uniqueness.
